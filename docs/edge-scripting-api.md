...
$bunnyHttpClient->request(
    new \ToshY\BunnyNet\Model\Api\EdgeScripting\Code\GetCode(
        id: 1,
    )
);
```
...
```php
$bunnyHttpClient->request(
    new \ToshY\BunnyNet\Model\Api\EdgeScripting\Code\SetCode(
        id: 1,
        body: [
...
```php
$bunnyHttpClient->request(
    new \ToshY\BunnyNet\Model\Api\EdgeScripting\EdgeScript\ListEdgeScripts(
        query: [
            'type' => [
                0,
                1,
...
```php
$bunnyHttpClient->request(
    new \ToshY\BunnyNet\Model\Api\EdgeScripting\EdgeScript\AddEdgeScript(
        body: [
            'Name' => 'Test Script',
...
??? note
    ...
    - The key `IntegrationId` is required when creating and deploying through GitHub. It can be retrieved from the [Get GitHub Integration](core-api.md#get-github-integration) endpoint.
...
```php
$bunnyHttpClient->request(
    new \ToshY\BunnyNet\Model\Api\EdgeScripting\EdgeScript\GetEdgeScript(
        id: 1,
    )
);
```
...
```php
$bunnyHttpClient->request(
    new \ToshY\BunnyNet\Model\Api\EdgeScripting\EdgeScript\GetEdgeScriptStatistics(
        id: 1,
        query: [
            'dateFrom' => 'm-d-Y',
            'dateTo' => 'm-d-Y',
...
```php
$bunnyHttpClient->request(
    new \ToshY\BunnyNet\Model\Api\EdgeScripting\EdgeScript\UpdateEdgeScript(
        id: 1,
        body: [
            'Name' => 'Test Script',
            'ScriptType' => 1,
...
```php
$bunnyHttpClient->request(
    new \ToshY\BunnyNet\Model\Api\EdgeScripting\EdgeScript\DeleteEdgeScript(
        id: 1,
        query: [
...
```php
$bunnyHttpClient->request(
    new \ToshY\BunnyNet\Model\Api\EdgeScripting\Variable\GetVariable(
        id: 1,
        variableId: 2,
    )
);
...
```php
$bunnyHttpClient->request(
    new \ToshY\BunnyNet\Model\Api\EdgeScripting\Variable\AddVariable(
        id: 1,
        body: [
            'Name' => 'NEW_VARIABLE',
            'Required' => true,
...
```php
$bunnyHttpClient->request(
    new \ToshY\BunnyNet\Model\Api\EdgeScripting\Variable\UpdateVariable(
        id: 1,
        variableId: 2,
        body: [
            'Required' => false,
...
```php
$bunnyHttpClient->request(
    new \ToshY\BunnyNet\Model\Api\EdgeScripting\Variable\UpsertVariable(
        id: 1,
        body: [
            'Name' => 'NEW_VARIABLE',
            'Required' => true,
...
```php
$bunnyHttpClient->request(
    new \ToshY\BunnyNet\Model\Api\EdgeScripting\Variable\DeleteVariable(
        id: 1,
        variableId: 2,
    )
);
...
```php
$bunnyHttpClient->request(
    new \ToshY\BunnyNet\Model\Api\EdgeScripting\Secret\ListSecrets(
        id: 1,
    )
);
```
...
```php
$bunnyHttpClient->request(
    new \ToshY\BunnyNet\Model\Api\EdgeScripting\Secret\AddSecret(
        id: 1,
        body: [
            'Name' => 'SECRET_KEY',
...
```php
$bunnyHttpClient->request(
    new \ToshY\BunnyNet\Model\Api\EdgeScripting\Secret\UpdateSecret(
        id: 1,
        secretId: 2,
        body: [
...
```php
$bunnyHttpClient->request(
    new \ToshY\BunnyNet\Model\Api\EdgeScripting\Secret\UpsertSecret(
        id: 1,
        body: [
            'Name' => 'SECRET_KEY',
...
```php
$bunnyHttpClient->request(
    new \ToshY\BunnyNet\Model\Api\EdgeScripting\Secret\DeleteSecret(
        id: 1,
        secretId: 2,
    )
);
...
```php
$bunnyHttpClient->request(
    new \ToshY\BunnyNet\Model\Api\EdgeScripting\Release\GetReleases(
        id: 1,
        query: [
            'page' => 1,
            'perPage' => 1000,
...
```php
$bunnyHttpClient->request(
    new \ToshY\BunnyNet\Model\Api\EdgeScripting\Release\GetActiveReleases(
        id: 1,
    )
);
```
