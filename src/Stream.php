...
use ToshY\BunnyNet\Enum\Stream\Collection\CollectionEndpoint;
use ToshY\BunnyNet\Enum\Stream\Video\VideoEndpoint;
...
final class Stream extends AbstractRequest
{
    ...
    {
        $endpoint = VideoEndpoint::FETCH_VIDEO_COLLECTION;
        $urlPath = $this->createUrlPath($endpoint['path'], [$libraryId]);
