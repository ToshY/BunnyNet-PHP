...
class CreateRateLimit implements ModelInterface, BodyModelInterface
{
    /**
        ...
        return [
            ...
            new AbstractParameter(name: 'ruleConfiguration', type: Type::OBJECT_TYPE, children: [
                ...
                new AbstractParameter(name: 'variableTypes', type: Type::OBJECT_TYPE, children: [
                    ...
                    new AbstractParameter(name: 'FINGERPRINT', type: Type::STRING_TYPE),
                    new AbstractParameter(name: 'VERIFIED_BOT_CATEGORY', type: Type::STRING_TYPE),
                ]),
                ...
                new AbstractParameter(name: 'counterKeyType', type: Type::INT_TYPE),
