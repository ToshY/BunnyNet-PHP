...
class AddRecordsBulk implements ModelInterface, BodyModelInterface
{
    /**
     * @param int $zoneId
    ...
    {
        return [
            new AbstractParameter(name: null, type: Type::ARRAY_TYPE, required: true, children: [
