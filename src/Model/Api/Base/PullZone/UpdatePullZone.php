...
class UpdatePullZone implements ModelInterface, BodyModelInterface
{
    /**
     * @param int $id
    ...
    public function getBody(): array
    {
        return [
            ...
            new AbstractParameter(name: 'PermaCacheType', type: Type::STRING_TYPE),
            ...
            new AbstractParameter(name: 'LogForwardingProtocol', type: Type::STRING_TYPE),
            ...
            new AbstractParameter(name: 'LogAnonymizationType', type: Type::STRING_TYPE),
            ...
            new AbstractParameter(name: 'EdgeScriptExecutionPhase', type: Type::STRING_TYPE),
            new AbstractParameter(name: 'OriginType', type: Type::STRING_TYPE),
            ...
            new AbstractParameter(name: 'LogFormat', type: Type::STRING_TYPE),
            new AbstractParameter(name: 'LogForwardingFormat', type: Type::STRING_TYPE),
            new AbstractParameter(name: 'ShieldDDosProtectionType', type: Type::STRING_TYPE),
            ...
            new AbstractParameter(name: 'PreloadingScreenTheme', type: Type::STRING_TYPE),
            ...
            new AbstractParameter(name: 'StickySessionType', type: Type::STRING_TYPE),
