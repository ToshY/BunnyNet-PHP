...
class UpdatePullZone implements ModelInterface, BodyModelInterface
{
    ...
    public function getBody(): array
    {
        return [
            ...
            new AbstractParameter(name: 'OptimizerStaticHtmlEnabled', type: Type::BOOLEAN_TYPE),
            ...
            new AbstractParameter(name: 'PreloadingScreenShowOnFirstVisit', type: Type::BOOLEAN_TYPE),
