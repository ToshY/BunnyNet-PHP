...
class PatchApplication implements ModelInterface, BodyModelInterface
{
    /**
     * @param string $appId
    ...
    public function getBody(): array
    {
        return [
            ...
            new AbstractParameter(name: 'runtimeType', type: Type::STRING_TYPE),
            new AbstractParameter(name: 'autoScaling', type: Type::OBJECT_TYPE, children: [
            ...
            new AbstractParameter(name: 'regionSettings', type: Type::OBJECT_TYPE, children: [
