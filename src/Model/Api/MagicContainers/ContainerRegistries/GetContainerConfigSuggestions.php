...
class GetContainerConfigSuggestions implements ModelInterface, BodyModelInterface
{
    /**
    ...
    {
        return 'registries/config-suggestions';
    }
    ...
    public function getBody(): array
    {
        return [
            ...
            new AbstractParameter(name: 'tag', type: Type::STRING_TYPE, required: true),
        ];
    }
}
