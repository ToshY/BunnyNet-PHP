...
class PatchApplicationContainerTemplate implements ModelInterface, BodyModelInterface
{
    /**
     * @param string $appId
    ...
    public function getBody(): array
    {
        return [
            ...
            new AbstractParameter(name: 'imageName', type: Type::STRING_TYPE),
            new AbstractParameter(name: 'imageNamespace', type: Type::STRING_TYPE),
            new AbstractParameter(name: 'imageTag', type: Type::STRING_TYPE),
            new AbstractParameter(name: 'imageDigest', type: Type::STRING_TYPE),
            new AbstractParameter(name: 'imageRegistryId', type: Type::STRING_TYPE),
