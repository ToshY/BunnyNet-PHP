 ...
 * @note undocumented
 */
class SetZoneSecurityIncludeHashRemoteIPEnabled implements EndpointInterface, EndpointBodyInterface
{
    ...
    {
        return 'pullzone/setZoneSecurityIncludeHashRemoteIPEnabled';
    }
